...
class Trainer:
    ...
    def train_epoch(self) -> Dict[str, float]:
        ...
        for batch_idx, batch in enumerate(pbar):
            ...
            if 'attr_loss' in loss_dict:
                attr_loss_meter.update(loss_dict['attr_loss'].item(), images.size(0))
    ...
    def train(self) -> Dict[str, Any]:
        ...
        for epoch in range(self.config.epochs):
            ...
            # Print epoch summary
            epoch_timer.stop()
            print(f"\nEpoch {epoch + 1}/{self.config.epochs} | Time: {epoch_timer}")
        ...
        timer.stop()
        print(f"\n{'='*60}")
        print(f"Training completed in {timer}")
        print(f"Best validation accuracy: {self.best_metric:.4f} at epoch {self.best_epoch + 1}")
        print(f"{'='*60}\n")
...
if __name__ == "__main__":
    ...
    print("Use this module to train your bird classification model.")
